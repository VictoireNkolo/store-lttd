...
@section('title', 'Editer une sous-catégorie | LTDD Administration')
@section('dashboard_section', 'Mise à jour sous-catégorie de produits / '.$productSubcategory->name)
        ...
        <div class="col-lg-8">
            <div class="card mt-3">
                <div class="card-header">
                    <i class="fa fa-fw fa-pencil-square-o text-primary"></i> Mise à jour sous-cat&eacute;gorie de produits
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('lb_admin.admin.product_subcategory.update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            >
                                @foreach($productCategories as $productCategory)
                                    <option
                                        ...
                                        {{ $productCategory->id === $productSubcategory->product_category_id ? 'selected' : '' }}
                                    >
                        ...
                        <div class="form-group">
                            ...
                            <input
                                class="form-control @error('name') is-invalid @enderror" value="{{ $productSubcategory->name }}"
